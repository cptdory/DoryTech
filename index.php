...
<body
    ...
    <nav class="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">DoryTech</span>
            </a>
    ...
    <!-- jumbotron -->
    <section id="home" class="mb-5 bg-center bg-no-repeat bg-[url('https://images.wallpaperscraft.com/image/single/code_text_colorful_140555_1920x1080.jpg')] bg-gray-700 bg-blend-multiply">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Powering Businesses, Simplifying Tech.</h1>
            <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">DoryTech provides hassle-free system rentals for businesses. With seamless hosting, maintenance, and support, you can focus on growth while we handle the tech. Simple, reliable, and cost-effective experience technology without the complexity.
            </p>
    ...
    <!-- Services -->
    <section id="services">
    <h1 class="items-center mb-4 flex flex-col text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">SERVICES</span></h1> 
        <div class="ml-5 mr-5">
            <ul class="grid grid-cols-3 gap-4 space-y-4 mb-4">
                <li class="col-span-1">
                    ...
                    <label for="job-1" class="inline-flex items-center justify-between w-full p-5 text-gray-900 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-500 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 dark:peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-900 hover:bg-gray-100 dark:text-white dark:bg-gray-600 dark:hover:bg-gray-500">
                        <div class="block">
                            <div class="w-full text-lg font-semibold">Point of Sale (POS) Systems</div>
                            <div class="w-full text-gray-500 dark:text-gray-400">Streamlined sales processing with reporting & analytics.</div>
                        </div>
                ...
                <li class="col-span-1">
                    ...
                    <label for="job-2" class="inline-flex items-center justify-between w-full p-5 text-gray-900 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-500 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 dark:peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-900 hover:bg-gray-100 dark:text-white dark:bg-gray-600 dark:hover:bg-gray-500">
                        <div class="block">
                            <div class="w-full text-lg font-semibold">Inventory Management Systems</div>
                            <div class="w-full text-gray-500 dark:text-gray-400">Track stock levels, manage suppliers, and automate restocking.</div>
                        </div>
                        <svg class="w-4 h-4 ms-3 rtl:rotate-180 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                        </svg>
                ...
                <li class="col-span-1">
                    ...
                    <label for="job-3" class="inline-flex items-center justify-between w-full p-5 text-gray-900 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-500 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 dark:peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-900 hover:bg-gray-100 dark:text-white dark:bg-gray-600 dark:hover:bg-gray-500">
                        <div class="block">
                            <div class="w-full text-lg font-semibold">Admin & HR Management Systems</div>
                            <div class="w-full text-gray-500 dark:text-gray-400">Employee records, payroll, scheduling, and attendance tracking.</div>
                        </div>
                        <svg class="w-4 h-4 ms-3 rtl:rotate-180 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                        </svg>
    ...
    <section id="pricing" class="mb-5">
        <h1 class="items-center mb-4 flex flex-col text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">PRICING</span></h1>
        <div class="flex justify-around flex-row flex-wrap">
            <div class="mb-5 w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Basic plan</h5>
                <div class="flex items-baseline text-gray-900 dark:text-white">
                    <span class="text-3xl font-semibold">₱</span>
                    <span class="text-5xl font-extrabold tracking-tight">xx</span>
    ...
    <footer class="bg-white dark:bg-gray-900">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© <?php echo $currentYear; ?> <a href="#" class="hover:underline">DoryTech</a>. All Rights Reserved.
                </span>
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    <a href="https://www.facebook.com/dorytechCo/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
